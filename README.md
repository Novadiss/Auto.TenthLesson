...
6. Применение промокода в меню записи для зарегистрированного и незарегистрированного пользователей.
        ...
        2. Ввод валидного промокода и нажатие кнопки "Применить".
   ...
   и незарегистрированного (Поля "Имя", "Телефон" и "Электронная почта") пользователей.
           ...
           3. Тестирование формы "Имя" на валидные значения. 
              ...
              после нажатие кнопки "Записаться":
               Ввод имени на кирилице. Ожидание: переход на страницу выбора оплаты курса.
               Ввод имени на кирилице с буквами "Ё" и "Й". Ожидание: переход на страницу выбора оплаты курса.
               Ввод имени на латинице. Ожидание: переход на страницу выбора оплаты курса.
               Ввод двойного имени, через пробел. Ожидание: переход на страницу выбора оплаты курса.
               Ввод двойного имени, через тире. Ожидание: переход на страницу выбора оплаты курса.
               Ввод имени с разным регистром. Ожидание: переход на страницу выбора оплаты курса.
               Ввод имени с апострофом. Ожидание: переход на страницу выбора оплаты курса.
           4. Тестирование формы "Телефон" на валидные значения. 
              ...
              после нажатие кнопки "Записаться":
               Ввод 11 цифр. Ожидание: переход на страницу выбора оплаты курса.
               Ввод 11 цифр используя символы "+" "(" ")" "-". Ожидание: переход на страницу выбора оплаты курса.
               Ввод 11 цифр через пробел. Ожидание: переход на страницу выбора оплаты курса.
           5. Тестирование формы "Электронная почта" на валидные значения. 
              ...
              после нажатие кнопки "Записаться" (Стандарт для почты ***@почта.домен):
               Ввод почты на латинице. Ожидание: переход на страницу выбора оплаты курса.
               Ввод почты на кирилице (до @**.**). Ожидание: переход на страницу выбора оплаты курса.
               Ввод почты с использованием цифр. Ожидание: переход на страницу выбора оплаты курса.
               Ввод почты используя символ "!". Ожидание: переход на страницу выбора оплаты курса.
   ...
   и незарегистрированного (Поля "Имя", "Телефон" и "Электронная почта") пользователей.
           ...
           5. Тестирование формы "Электронная почта" на невалидные значения. 
              ...
              после нажатие кнопки "Записаться" (Стандарт для почты название@ресурс.домен):
               Ввод с нарушением стандарта (без @**.**). Ожидание: ошибка "Неверный email".
               Ввод почты на кирилице (после **@). Ожидание: ошибка "Неверный email"..
               Ввод почты используя символы кроме "!". Ожидание: ошибка "Неверный email".
               Ввод почты используя цифры (после **@). Ожидание: ошибка "Неверный email".
...
![img_8.png](img_8.png)
        ...
        6. Тестирование формы "Ссылка на найденный курс" на валидные значения.
            ...
            и тестовых данных в поле "Ссылка на найденный курс", после нажатие кнопки "Записаться":
             Ввод в поле всех возможных букв и символов, в количестве больше 1го.
              Ожидание: ответ "Ваш запрос принят, с вами свяжутся для уточнения стоимости".
...
7. Проверка подсветки кликабельных кнопок и ссылок в меню записи.
